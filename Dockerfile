...
# set japanese image soure if dev environment
RUN if [ $ENV = dev ]; then \
...
COPY /docker/vhost.conf /etc/nginx/conf.d/default/vhost.conf
COPY /docker/pool.conf /etc/php-fpm.d/www.conf
COPY /docker/entrypoint.sh /usr/local/bin/entrypoint.sh
COPY /docker/certs/nginx.crt /etc/nginx/ssl/nginx.crt
COPY /docker/certs/nginx.key /etc/nginx/ssl/nginx.key
